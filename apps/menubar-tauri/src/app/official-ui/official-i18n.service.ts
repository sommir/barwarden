...
const translations: Readonly<Record<string, string>> = {
  ...
  i18nAppearance: "外观",
  i18nAutofill: "填充",
  i18nShowInputFieldIcon: "在输入框附近显示图标",
  i18nShowInputFieldIconHint: "关闭后仍可从密码库、快捷键和系统自动填充使用填充功能。",
  i18nAutofillPickerTitle: "自动填充",
  i18nAutofillCurrentApp: "当前应用",
  i18nAutofillVaultLocked: "密码库已锁定",
  i18nAutofillUnlockDescription: "解锁 Barwarden 后，才能查看和填入账户。",
  i18nAutofillNeedsAttention: "自动填充需要处理",
  i18nAutofillApprovalDescription: "请前往“系统设置 > 通用 > 登录项”允许 Barwarden AutoFill，然后重试。",
  i18nAutofillRepairDescription: "后台自动填充服务暂不可用，请重试。",
  i18nAutofillTurnOff: "关闭自动填充",
  i18nAutofillShortcutUnavailable: "快捷键正被其他应用或 Barwarden 实例占用",
  i18nAutofillTargetUnavailable: "未检测到可填入的输入框",
  i18nAutofillTargetUnavailableDescription: "返回目标应用并聚焦输入框后，再按已设置的自动填充快捷键。",
  i18nBackToVault: "返回密码库",
  i18nAutofillChooseAccount: "选择要使用的账户",
  i18nAutofillAccountDescription: "当前密码库与自动填充服务使用了不同账户。切换后再继续。",
  i18nAutofillUseAccount: "切换到自动填充账户",
  i18nAutofillFindingAccounts: "正在查找可用账户…",
  i18nAutofillChooseField: "选择要填入的字段",
  i18nAutofillChooseDetectedField: "选择填入字段",
  i18nAutofillDetectedContext: "已识别{0}",
  i18nAutofillSearchAccounts: "搜索账户",
  i18nAutofillAccountsForApp: "“{0}”的可用账户",
  i18nAutofillNoMatches: "没有找到匹配的账户",
  i18nAutofillNoMatchesDescription: "换一个关键词，或清空搜索查看当前应用的推荐账户。",
  i18nAutofillExactMatches: "精确匹配",
  i18nAutofillSuggestions: "自动填充建议",
  i18nAutofillSuggestionCount: "找到{0}个自动填充建议",
  i18nAutofillSuggestionFill: "填充“{0}”",
  i18nAutofillNoConfidentField: "无法确定要填入的字段。",
  i18nAutofillConfirmMatch: "确认自动填充",
  i18nAutofillRelevantAccounts: "相关账户",
  i18nAutofillOtherAccounts: "其他账户",
  i18nAutofillFill: "填入",
  i18nAutofillAvailableFields: "可填入：{0}",
  i18nAutofillFillField: "填入{0}",
  i18nAutofillFillForm: "填入登录表单",
  i18nAutofillMoreActions: "更多填入方式",
  i18nAutofillViewDetails: "查看“{0}”详情",
  i18nAutofillCopyOnly: "仅复制，不填入",
  i18nAutofillCopyDescription: "将“{0}”的{1}复制到剪贴板",
  i18nAutofillFieldUsername: "用户名",
  i18nAutofillFieldPassword: "密码",
  i18nAutofillFieldTotp: "验证码",
  i18nAutofillLoginForm: "登录表单",
  i18nAutofillFillCandidate: "使用{1}填入{0}",
  i18nAutofillReasonBinding: "已绑定此应用",
  i18nAutofillReasonService: "服务标识完全匹配",
  i18nAutofillReasonPreset: "常用应用预设",
  i18nAutofillReasonUriRule: "登录地址完全匹配",
  i18nAutofillReasonDomain: "域名相关",
  i18nAutofillReasonApplicationName: "应用名称相同",
  i18nAutofillReasonApplicationNameSimilar: "应用名称相似",
  i18nAutofillReasonSimilar: "名称相似",
  i18nAutofillReasonHistory: "之前在此应用使用过",
  i18nAutofillReasonFavorite: "收藏账户",
  i18nAutofillReasonRecent: "最近使用",
  i18nAutofillReasonOther: "其他账户",
  i18nAutofillMismatchDescription: "此账户与当前应用不完全匹配。确定仍要填入吗？",
  i18nAutofillFillAnyway: "仍然填入",
  i18nAutofillVerifyDescription: "此账户需要先验证身份。",
  i18nVerify: "验证",
  i18nAutofillChecking: "正在检查自动填充…",
  i18nAutofillStillNeedsAttention: "自动填充仍需要处理。",
  i18nAutofillRecoveryFailed: "无法恢复自动填充，请重试。",
  i18nAutofillTurningOff: "正在关闭自动填充…",
  i18nAutofillIsOff: "自动填充已关闭。",
  i18nAutofillTurnOffFailed: "无法关闭自动填充，请重试。",
  i18nAutofillFieldUnavailable: "所选账户没有这个字段。",
  i18nAutofillActionFailed: "无法完成这次自动填充操作。",
  i18nAutofillTouchIdCancelled: "已取消 Touch ID 验证。",
  i18nAutofillTouchIdFailed: "Touch ID 验证失败。",
  i18nAutofillMasterPasswordFailed: "主密码验证失败。",
  i18nAutofillSwitchAccountFailed: "无法切换账户。",
  i18nAutofillReleaseFailed: "无法读取这个字段。",
  i18nAutofillCopied: "已复制。",
  i18nAutofillFilled: "已填入。",
  i18nAutofillPartial: "已填入{0}；未能填入{1}。",
  i18nAutofillNoFields: "无字段",
  i18nAutofillTargetChanged: "目标输入框已变化，请重新打开自动填充。",
  i18nAutofillActionUnavailable: "此自动填充操作已失效，请重新选择。",
  i18nAutofillPasteFallback: "无法自动粘贴，内容已复制，请在目标应用中手动粘贴。",
  i18nAutofillPasteFailed: "无法粘贴这个字段。",
  i18nAllowAutofill: "允许自动填充",
  i18nAccessibilityInstructions: "已复制到剪贴板。若要自动粘贴到其他应用，请在“系统设置”中允许 Barwarden 使用辅助功能。",
  i18nAutofillAccessibilityDescription: "若要在其他应用的输入框旁显示 Barwarden 账号选择按钮，请在“系统设置 > 隐私与安全性 > 辅助功能”中允许 Barwarden，然后重试。",
  i18nCallout: "通知",
...
const englishTranslations: Readonly<Record<string, string>> = {
  ...
  i18nShowInputFieldIcon: "Show an icon near input fields",
  i18nShowInputFieldIconHint: "Vault suggestions, shortcuts, and system AutoFill remain available when this is off.",
  i18nAutofillPickerTitle: "AutoFill",
  i18nAutofillCurrentApp: "Current app",
  i18nAutofillVaultLocked: "Vault locked",
  i18nAutofillUnlockDescription: "Unlock Barwarden to view and fill your accounts.",
  i18nAutofillNeedsAttention: "AutoFill needs attention",
  i18nAutofillApprovalDescription: "Allow Barwarden AutoFill in System Settings > General > Login Items, then try again.",
  i18nAutofillRepairDescription: "The AutoFill background service is unavailable. Try again.",
  i18nAutofillTurnOff: "Turn off AutoFill",
  i18nAutofillShortcutUnavailable: "The shortcut is in use by another app or Barwarden instance",
  i18nAutofillTargetUnavailable: "No fillable field detected",
  i18nAutofillTargetUnavailableDescription: "Return to the target app, focus a field, then use your configured AutoFill shortcut.",
  i18nBackToVault: "Back to vault",
  i18nAutofillChooseAccount: "Choose an account",
  i18nAutofillAccountDescription: "The vault and AutoFill service are using different accounts. Switch accounts to continue.",
  i18nAutofillUseAccount: "Switch to AutoFill account",
  i18nAutofillFindingAccounts: "Finding available accounts…",
  i18nAutofillChooseField: "Choose a field to fill",
  i18nAutofillChooseDetectedField: "Choose a field to fill",
  i18nAutofillDetectedContext: "Detected {0}",
  i18nAutofillSearchAccounts: "Search accounts",
  i18nAutofillAccountsForApp: "Accounts available for “{0}”",
  i18nAutofillNoMatches: "No matching accounts",
  i18nAutofillNoMatchesDescription: "Try another search, or clear it to see recommendations for this app.",
  i18nAutofillExactMatches: "Exact matches",
  i18nAutofillSuggestions: "AutoFill suggestions",
  i18nAutofillSuggestionCount: "{0} AutoFill suggestions found",
  i18nAutofillSuggestionFill: "Fill “{0}”",
  i18nAutofillNoConfidentField: "The field to fill could not be determined.",
  i18nAutofillConfirmMatch: "Confirm AutoFill",
  i18nAutofillRelevantAccounts: "Related accounts",
  i18nAutofillOtherAccounts: "Other accounts",
  i18nAutofillFill: "Fill",
  i18nAutofillAvailableFields: "Can fill: {0}",
  i18nAutofillFillField: "Fill {0}",
  i18nAutofillFillForm: "Fill login form",
  i18nAutofillMoreActions: "More fill actions",
  i18nAutofillViewDetails: "View details for “{0}”",
  i18nAutofillCopyOnly: "Copy only",
  i18nAutofillCopyDescription: "Copy the {1} for “{0}” to the clipboard",
  i18nAutofillFieldUsername: "Username",
  i18nAutofillFieldPassword: "Password",
  i18nAutofillFieldTotp: "Verification code",
  i18nAutofillLoginForm: "Login form",
  i18nAutofillFillCandidate: "Fill {0} from {1}",
  i18nAutofillReasonBinding: "Bound to this app",
  i18nAutofillReasonService: "Exact service match",
  i18nAutofillReasonPreset: "Known app preset",
  i18nAutofillReasonUriRule: "Exact login address",
  i18nAutofillReasonDomain: "Related domain",
  i18nAutofillReasonApplicationName: "Same application name",
  i18nAutofillReasonApplicationNameSimilar: "Similar application name",
  i18nAutofillReasonSimilar: "Similar name",
  i18nAutofillReasonHistory: "Previously used in this app",
  i18nAutofillReasonFavorite: "Favorite account",
  i18nAutofillReasonRecent: "Recently used",
  i18nAutofillReasonOther: "Other account",
  i18nAutofillMismatchDescription: "This account does not exactly match the current app. Fill it anyway?",
  i18nAutofillFillAnyway: "Fill anyway",
  i18nAutofillVerifyDescription: "Verify your identity before using this account.",
  i18nVerify: "Verify",
  i18nAutofillChecking: "Checking AutoFill…",
  i18nAutofillStillNeedsAttention: "AutoFill still needs attention.",
  i18nAutofillRecoveryFailed: "AutoFill recovery could not complete. Try again.",
  i18nAutofillTurningOff: "Turning off AutoFill…",
  i18nAutofillIsOff: "AutoFill is off.",
  i18nAutofillTurnOffFailed: "AutoFill could not be turned off. Try again.",
  i18nAutofillFieldUnavailable: "This field is unavailable for the selected account.",
  i18nAutofillActionFailed: "AutoFill could not complete this field action.",
  i18nAutofillTouchIdCancelled: "Touch ID verification was cancelled.",
  i18nAutofillTouchIdFailed: "Touch ID verification failed.",
  i18nAutofillMasterPasswordFailed: "Master password verification failed.",
  i18nAutofillSwitchAccountFailed: "Unable to switch accounts.",
  i18nAutofillReleaseFailed: "AutoFill could not release this field.",
  i18nAutofillCopied: "Copied.",
  i18nAutofillFilled: "Filled.",
  i18nAutofillPartial: "Filled {0}; could not fill {1}.",
  i18nAutofillNoFields: "no fields",
  i18nAutofillTargetChanged: "The target field changed. Open AutoFill again.",
  i18nAutofillActionUnavailable: "This AutoFill action expired. Select the account again.",
  i18nAutofillPasteFallback: "Copied. Paste into the target app manually.",
  i18nAutofillPasteFailed: "AutoFill could not paste this field.",
  ...
  i18nAutofillAccessibilityDescription: "To show the Barwarden account picker beside fields in other apps, allow Barwarden in System Settings > Privacy & Security > Accessibility, then retry.",
