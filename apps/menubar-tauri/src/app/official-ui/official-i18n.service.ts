...
const translations: Readonly<Record<string, string>> = {
  ...
  i18nAutofillTargetUnavailableDescription: "返回目标应用并聚焦输入框后，按 ⌥B 再试一次。",
...
const englishTranslations: Readonly<Record<string, string>> = {
  ...
  i18nAutofillTargetUnavailableDescription: "Return to the target app, focus a field, then press ⌥B to try again.",
